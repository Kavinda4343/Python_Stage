...
#
#     rectangle = plt.Rectangle((0, 450), 500, 60, color="gray", zorder=10)
#     ax1.add_patch(rectangle)
#
...
#
#     # Load the JPEG image
#     image = imageio.imread("D:\JANA\Test_Sample\Stage\Capture.jpg")
#
#     # Display the image in front of the screen
#     ax1.imshow(image, extent=[0, 500, 0, 500], alpha=0.5, zorder=10)
#
#     for a in range(300):
#         bubbles.stepChange()
...
def main():
    ...
    image_x = (screen_width - image_width) / 2.8
